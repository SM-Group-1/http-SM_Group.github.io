...
const Topbtn = document.querySelector(".scrollTop-btn");

window.addEventListener("scroll", function () {
    Topbtn.classList.toggle("active", this.window.scrollY > 500);
});
...
//Scroll reveal animations, Common reveal options to create reveal animations
ScrollReveal({
    // reset:true,
    distance: '60px',
    duration: 2500,
...
ScrollReveal().reveal('.about .porfessional-list li', {
    delay: 500,
    origin: 'right',
    interval: 200
});
ScrollReveal().reveal('.skills-description ,.serives-description,.contact-card, .client-swiper,.contact-left h2', {
    delay: 700,
    origin: 'left'
});
